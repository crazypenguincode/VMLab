...
namespace VMLab.CommandHandler.Snapshot
{
    public class AddSnapshotHandler : BaseParamHandler
    {
        ...
        public AddSnapshotHandler(IUsage usage, IConsole console, IScriptEngine scriptEngine, IGraphManager graphManager, ISwitchParser switchParser, IVMManager vmManager) : base(usage)
        {
            _console = console;

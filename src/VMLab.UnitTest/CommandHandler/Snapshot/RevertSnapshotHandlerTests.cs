...
{
    public class RevertSnapshotHandlerTests
    {
        [Fact]
        public void When_CallingWithoutArgs_Should_ReportError()
        {
            ...
            var sut = fixture.Create<RevertSnapshotHandler>();
        ...
        public void When_CallingWithInvalidVMName_Should_ReportError()
        {
            ...
            //Act
            sut.OnHandle(new[] { "revert", "mysnapshot", "-vm", "nonexistingvm" });
        ...
        public void When_CallingAgainstExistingSnapshot_Should_CallRemoveSnapshot()
        {
            ...
            //Act
            sut.OnHandle(new[] { "revert", "mysnapshot" });

            //Assert
            A.CallTo(() => control.RevertToSnapshot("mysnapshot")).MustHaveHappened();
        }
    }
}
